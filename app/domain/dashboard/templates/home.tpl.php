                                    ...
                                    <ul class="dropdown-menu">
                                        <li><span class="radio"><input type="radio" name="groupBy" <?php if ($groupBy == "time") {
                                            echo "checked='checked'";
                                                                                                   }?> value="time" id="groupByDate" onclick="form.submit();"/><label for="groupByDate"><?=$this->__("label.dates") ?></label></span></li>
                                        <li><span class="radio"><input type="radio" name="groupBy" <?php if ($groupBy == "project") {
                                            echo "checked='checked'";
                                                                                                   }?> value="project" id="groupByProject" onclick="form.submit();"/><label for="groupByProject"><?=$this->__("label.project") ?></label></span></li>
                                    </ul>
                                </div>
                                <div class="right">
