    ...
    class pdf extends \tiggomark\domain\controllers\canvas\pdf
    {
        ...
        protected function htmlCanvas(array $recordsAry): string
        {
            $html = '<table class="canvas" style="width: 100%"><tbody>' .
                ...
                '</tr><tr>' .
                '  <td class="canvas-elt-title" colspan="2">' . $this->htmlCanvasTitle(
                    $this->canvasTypes['em_who']['title'],
                    $this->canvasTypes['em_who']['icon']
                ) . '</td>' .
                '  <td class="canvas-elt-title" colspan="2">' . $this->htmlCanvasTitle(
                    $this->canvasTypes['em_what']['title'],
                    $this->canvasTypes['em_what']['icon']
                ) . '</td>' .
                '</tr><tr>' .
                ...
                '</tr><tr>' .
                '  <td class="canvas-elt-title">' . $this->htmlCanvasTitle(
                    $this->canvasTypes['em_see']['title'],
                    $this->canvasTypes['em_see']['icon']
                ) . '</td>' .
                '  <td class="canvas-elt-title">' . $this->htmlCanvasTitle(
                    $this->canvasTypes['em_say']['title'],
                    $this->canvasTypes['em_say']['icon']
                ) . '</td>' .
                '  <td class="canvas-elt-title">' . $this->htmlCanvasTitle(
                    $this->canvasTypes['em_do']['title'],
                    $this->canvasTypes['em_do']['icon']
                ) . '</td>' .
                '  <td class="canvas-elt-title">' . $this->htmlCanvasTitle(
                    $this->canvasTypes['em_hear']['title'],
                    $this->canvasTypes['em_hear']['icon']
                ) . '</td>' .
                '</tr><tr>' .
                ...
                '</tr><tr>' .
                '  <td class="canvas-elt-title" colspan="2">' . $this->htmlCanvasTitle(
                    $this->canvasTypes['em_pains']['title'],
                    $this->canvasTypes['em_pains']['icon']
                ) . '</td>' .
                '  <td class="canvas-elt-title"colspan="2">' . $this->htmlCanvasTitle(
                    $this->canvasTypes['em_gains']['title'],
                    $this->canvasTypes['em_gains']['icon']
                ) . '</td>' .
                '</tr><tr>' .
                ...
                '</tr><tr>' .
                '  <td class="canvas-elt-title" colspan="4">' . $this->htmlCanvasTitle(
                    $this->canvasTypes['em_motives']['title'],
                    $this->canvasTypes['em_motives']['icon']
                ) . '</td>' .
                '</tr><tr>' .
